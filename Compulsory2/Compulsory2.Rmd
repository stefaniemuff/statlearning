...
## e) (2P) 
Now check whether the test MSE is actually better for the models in a) and b), compared to
...
(ii) (3P) Now construct a classification tree based on a more advanced method. Train the model using the training data and report the MSE for the test data. Explain your choice of the (tuning) parameters. Report the misclassification error on the test set. Which two variables are the most influential ones in the prediction of diabetes?
