...
Bagging can also be used for prediction methods (regression and classification) that are not trees. Bagging can improve accuracy when, according to @Breiman1996
