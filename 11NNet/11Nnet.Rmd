...
```{r}
set.seed(123)
iris.nnet <- nnet(species ~ ., data = ird, subset=train,  size = 0, skip=TRUE, rang = 0.1, maxit = 200)
```
...
* Examples: Linear, logistic and multinomial regression with without any _hidden layers_ (between the input and output layers).
...
The _\textcolor{red}{universal approximation theorem}_\footnote{Goodfellow et al 2016, p.198, https://www.deeplearningbook.org} says that a feedforward network with
