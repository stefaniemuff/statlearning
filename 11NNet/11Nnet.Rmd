...
The universal approximation theorem holds for the sigmoid (logistic) and ReLU activation functions in the hidden layer.
...
\center
```{r,echo=FALSE,fig.width=4,fig.height=3.5,out.width="60%"}
x=seq(-3,3,length=3)
y=pmax(0,x)
