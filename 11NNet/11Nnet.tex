...
\item
  ...
  partial derivative of the loss (over all historical values!) have a
  correspondingly rapid decrease in their learning rate. Nice properties
  when optimization is convex.
\end{itemize}
