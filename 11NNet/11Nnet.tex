...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit}\OperatorTok{$}\NormalTok{wts}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plotnet}\NormalTok{(fit5)}
\end{Highlighting}
\end{Shaded}

\includegraphics{11Nnet_files/figure-beamer/unnamed-chunk-19-1.pdf}
...
\includegraphics{11Nnet_files/figure-beamer/unnamed-chunk-21-1.pdf}
...
\includegraphics[width=0.3\textwidth,height=\textheight]{mnistex.png}
