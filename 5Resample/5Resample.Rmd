...
"Model selection" situation: We assume that test data is available (and has been put aside), and we want to use the rest of our data to both fit the data and to find the best model.
...
Note: We will see in the Recommended Exercises that doing the wrong thing can give a misclassification error approximately 0 - even if the "true" rate is 50%. (todo: modify this exercise back)
...
## Interactive lecture (Monday February 3rd)
...
## Interactive lecture on Monday

* **10:15-10:30:** [Introduction to R Markdown (by lecturer)](https://www.math.ntnu.no/emner/TMA4268/2019v/RMarkdownIntro.html) and the template to be used for Compulsory exercise 1 (approx 20 minutes). Download
<https://www.math.ntnu.no/emner/TMA4268/2019v/CompEx1mal.Rmd> (todo: change link) and also install the packages listed at the beginning of the exercise sheet (todo).

* **Rest of time:** Introduction to problems on cross-validation and bootstrap; work with problems and some discussion.

* **11:45:** Summing up problems and start Clicker Exercise on Module 5 (and indirectly 1-4).
