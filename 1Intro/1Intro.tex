...
\item
  Some weeks (modules 2, 5, 7 and 9) the second 2h are partly a lecture
  and partly an \emph{interactive lecture} in Smia, where active
  learning is in focus (more below).
\item
  The other weeks (modules 3, 4, 6, 8, 10 and 11) the second lecture is
  a plenary lecture in F6.
\item
...
\item
  This gives 20\% of the final evaluation in the course, and the written
  exam the final 70\%.
\end{itemize}
