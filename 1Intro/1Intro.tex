...
\item
  Solutions will be provided to check yourself.
\end{itemize}
...
\item
  ...
  1-5. \(~\) Suggested submission deadline: \textbf{Thursday, 20.
  Februar 2020, 12:00h}.
\end{itemize}
...
\item
  ...
  6-11. \(~\) Suggested submission deadline: \textbf{Monday, 13. April
  2020, 12:00h}.
\end{itemize}
...
\item
  \href{https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rbeginner.html}{\texttt{Rbeginner}},
  \href{https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rintermediate.html}{\texttt{Rintermediate}},
  and
  \href{https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rplots.html}{\texttt{Rplots}}
\end{itemize}
...
\tightlist
\item
  Statistical learning on the whole chain:
\end{itemize}
...
\begin{itemize}
\item
  extract knowledge and understanding from data, and \vspace{2mm}
\item
