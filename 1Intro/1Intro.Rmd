...
* [David Klindt](https://www.ntnu.no/ansatte/david.klindt); Postdoc/soon Meta (Module 12)
...
* We are starting with online classes due to the current restrictions around Covid.
...
But **do we need all of those**?

Log into www.menti.com  aud use the code 9384 0003.

<!-- https://www.mentimeter.com/s/502463fe2a5484c36ffc166e1f33ef6b/d35566f85e98 -->
...
* Work in **groups of maximum 3**; groups are formed in Blackboard (Bb). Also hand-in is via Bb in on Blackboard. 
...
[https://mattelab2022v.math.ntnu.no/c/tma4268/9](https://mattelab2022v.math.ntnu.no/c/tma4268/9)
...
* Watch the video lecture for Chapter 1 by Hastie and Tibshirani [here](https://wiki.math.ntnu.no/tma4268/2022v/subpage1).
