...
* Stefanie Muff (IMF and CBD at NTNU)
...
* Some weeks (modules 2, 5, 7 and 9) the second 2h are partly a lecture and partly an _interactive lecture_ in Smia, where active learning is in focus (more below).
...
* We will have **two compulsory exercises**, each with a maximal score of 15 points.
...
* This gives 20% of the final evaluation in the course, and the written exam the final 70%.
