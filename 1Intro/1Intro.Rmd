...
* The **first compulsory exercises** will be held after Modules 1-5. 
  $~$
  Suggested submission deadline: **Thursday, 20. Februar 2020, 12:00h**.

\vspace{4mm}

* The **second compulsory exercise** will be held after Modules 6-11.
 $~$
  Suggested submission deadline: **Monday, 13. April 2020, 12:00h**.
...
* [\texttt{Rbeginner}](https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rbeginner.html), [\texttt{Rintermediate}](https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rintermediate.html), and
[\texttt{Rplots}](https://github.com/stefaniemuff/statlearning/blob/master/1Intro/Rplots.html)
