...
title: "Module 2: Recommeded exercises"
...
![$f(x)=-x+x^2+x^3$](Prob1f1.png){width=40%}
...
![Mean squared errors for training and test sets](Prob1f3.png){width=80%}
...
![Figure 4](Prob1f4.png){width=60%}

![Figure 5](Prob1f5.png){width=80%}
