...
correctly predict the class membership. \vspace{1mm}
...
\(\rightarrow\) The majority of problems studied here fall in the
...
\item
  ...
  \(K\)-nearest neighbour algorithm in Module 4.
\end{itemize}
