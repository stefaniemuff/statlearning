...
\begin{align*} 
 K(X,X') &= (1 + \langle X,X' \rangle) \\ 
 &= (1 + X_1X_1' + X_2X_2')^2 \\
 &= 1 + 2X_1X_1' + 2X_2X_2' + (X_1X_1')^2 + (X_2X_2')^2 + 2X_1X_1'X_2X_2'.
\end{align*}
We have that $h_1(X) = 1,$ $h_2(X) = \sqrt2X_1,$ $h_3(X) = \sqrt2X_2,$ $h_4(X) = X_1^2,$ $h_5(X) = X_2^2,$ $h_6(X) = \sqrt2X_1X_2,$
that is the the enlarged space created by the Kernel $K(X,X') = \langle h(X),  h(X') \rangle$ has dimension $M=6$.
