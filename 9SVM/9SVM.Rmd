...
3. Look at the figure below (Figure 9.5 from ISRL). What could be the problem with the (maximal margin) hyperplane idea?

<!-- overfitting the data; not so robust -->
<!-- Mainly when $p$ is large. -->

\centering
![](../../ISLR/Figures/Chapter9/9.5.png){width=80%}
