...
* When there are more predictors than observations it is always possible to find a separating hyperplane in the predictor space, but it might not be the "best" hyperplane for us.
...
See also Figure 19.3 in @casi, where the violations (estimates of $\epsilon_i$) are shown in green:
