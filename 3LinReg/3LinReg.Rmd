...
* A quantitative response vs. one or several explanatory variables (quantitative or qualitate).
...
Add your answer into the google sheet: https://docs.google.com/spreadsheets/d/1DishfNIsYmmcTmNjsTDGeyBK9FElC7yGpyYJoK32SyI/edit?usp=sharing
...
**Again**: We will derive this in the multiple linear regression version in more generality (see recommended exercises).
...
```{r,out.width='85%',fig.height=4,fig.width=5}
library(GGally)
ggpairs(Credit[,c(2,6,11,12)],aes(colour=Ethnicity))
```
...
```{r,echo=FALSE, fig.width=3.8, fig.height=3.8,fig.align = "center",out.width='45%'}
