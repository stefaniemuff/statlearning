...
\tightlist
\item
  \(\mathsf{E}(\boldsymbol{\varepsilon})=\boldsymbol{0}\).
\item
...
\emph{true} value \(Y\) varies around \(\hat{Y}\). We can compute a
...
\begin{center}\includegraphics[width=0.45\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-25-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-26-1} \end{center}
...
\protect\hypertarget{other-considerations-in-the-regression-model}{}
