...
\item
  ...
  the sum of \emph{\textcolor{red}{squared vertical distances}}
...
\emph{\textcolor{red}{consider not only the uncertainty in the predicted value}}
\(\hat y_0 = \hat\beta_0 + \hat\beta_1 x_1^{(0)} + \ldots \hat\beta_p x_p^{(0)}\),
but also the \emph{\textcolor{red}{irreducible error}}
...
\begin{center}\includegraphics[width=0.8\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-30-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{3LinReg_files/figure-beamer/unnamed-chunk-32-1} \end{center}
...
\(\rightarrow\) The \emph{\textcolor{red}{degrees of freedom}} of the
model are also reduced by \(k-1\).
