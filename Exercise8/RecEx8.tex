...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{4268}\NormalTok{)}
\NormalTok{cv.Carseats =}\StringTok{ }\KeywordTok{cv.tree}\NormalTok{(...)}
\NormalTok{tree.min =}\StringTok{ }\KeywordTok{which.min}\NormalTok{(...)}
\NormalTok{best =}\StringTok{ }\NormalTok{cv.Carseats}\OperatorTok{$}\NormalTok{size[...]}
\end{Highlighting}
\end{Shaded}
