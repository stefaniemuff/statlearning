...
\NormalTok{r.boost }\OtherTok{=} \FunctionTok{gbm}\NormalTok{(Sales }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., Carseats.train, }\AttributeTok{distribution =}\NormalTok{ ..., }\AttributeTok{n.trees =}\NormalTok{ ..., }\AttributeTok{interaction.depth =}\NormalTok{ ...,}
    \AttributeTok{shrinkage =}\NormalTok{ ...)}
\end{Highlighting}
\end{Shaded}
