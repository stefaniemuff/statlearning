...
# What is next?
You may now move to [Rintermediate.html](https://htmlpreview.github.io/?https://github.com/stefaniemuff/statlearning/blob/master/Exercise1/Rintermediate.html) to see how R can be used on topics that should already be familiar to you from TMA4240/TMA4245 Statistics - or similar courses. Or, if you did ST1201 you can look at an overview of how the methods in ST1201 can be performed in R: [ST1201inR.html](https://www.math.ntnu.no/emner/TMA4268/2019v/1Intro/ST1201inR.html)
